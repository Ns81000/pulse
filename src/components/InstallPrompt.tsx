      ...
      >
        <div className="flex items-start gap-3 rounded-2xl border border-[var(--border-default)] bg-[var(--surface-1)] p-4 shadow-[0_20px_60px_-10px_rgba(0,0,0,0.8)]">
          ...
          <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-[var(--surface-3)]">
            <svg width="28" height="28" viewBox="-7 -7 131 131" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <div className="relative w-full max-w-sm rounded-t-3xl border border-[var(--border-default)] bg-[var(--surface-1)] p-6 pb-[calc(env(safe-area-inset-bottom)+24px)] sm:rounded-2xl sm:pb-6 slide-up">
            ...
            <ol className="space-y-4">
              <li className="flex items-start gap-3">
                <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-[var(--accent)] text-[11px] font-bold text-white">1</span>
                <p className="text-[13.5px] text-[var(--text-secondary)]">
                  Tap the <strong className="text-[var(--text-primary)]">Share</strong> button{" "}
                  <span className="inline-flex size-5 items-center justify-center rounded bg-[var(--surface-3)] align-middle text-[11px]">⎙</span>{" "}
                  at the bottom of your browser
                </p>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-[var(--accent)] text-[11px] font-bold text-white">2</span>
                <p className="text-[13.5px] text-[var(--text-secondary)]">
                  Scroll down and tap{" "}
              ...
              <li className="flex items-start gap-3">
                <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-[var(--accent)] text-[11px] font-bold text-white">3</span>
                <p className="text-[13.5px] text-[var(--text-secondary)]">
                  Tap <strong className="text-[var(--text-primary)]">Add</strong> — Pulse will appear on your home screen
                </p>
              </li>
            </ol>
            ...
            <button
              type="button"
              onClick={() => { setIosInstructions(false); handleDismiss(); }}

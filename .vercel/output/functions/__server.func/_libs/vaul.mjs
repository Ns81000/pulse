...
import {
  ...
  s as DialogTitle,
  t as Dialog,
} from "./@radix-ui/react-dialog+[...].mjs";
//#region node_modules/.pnpm/vaul@1.1.2_@types+react-dom_78a8d4aff1f8ccd490e673c1388b34eb/node_modules/vaul/dist/index.mjs
...
function useSnapPoints({
  ...
  const [windowDimensions, setWindowDimensions] = import_react.useState(
    typeof window !== "undefined"
      ? {
  ...
  const isLastSnapPoint = import_react.useMemo(
    () =>
  ...
  const activeSnapPointOffset = import_react.useMemo(
    () =>
  ...
  const snapToPoint = import_react.useCallback(
    (dimension) => {
...
function useScaleBackground() {
  ...
  const initialBackgroundColor = (0, import_react.useMemo)(
 ...
 */ function usePositionFixed({
  ...
  const [activeUrl, setActiveUrl] = import_react.useState(() =>
...
function Root({
  ...
  import_react.useEffect(() => {
    ...
    return () => {
      var _window_visualViewport;
      return (_window_visualViewport = window.visualViewport) == null
        ? void 0
        : _window_visualViewport.removeEventListener("resize", onVisualViewportChange);
    };
  ...
  function onRelease(event) {
    ...
    if (
      ...
      (direction === "left" || direction === "right" ? visibleDrawerWidth : visibleDrawerHeight) *
        closeThreshold
    ) {
      closeDrawer();
      onReleaseProp?.(event, false);
...
var Content = /*#__PURE__*/ import_react.forwardRef(function (
...
var Handle = /*#__PURE__*/ import_react.forwardRef(function (

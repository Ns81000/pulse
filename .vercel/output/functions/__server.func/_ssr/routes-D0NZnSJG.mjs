...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-D0NZnSJG.js
...
function ImmersiveLanding({ onClose }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const draw = () => {
			...
			if (mouse.active) if (currentMouseX === -1e3) {
				currentMouseX = mouse.targetX;
				currentMouseY = mouse.targetY;
			} else {
				currentMouseX += (mouse.targetX - currentMouseX) * .12;
				currentMouseY += (mouse.targetY - currentMouseY) * .12;
			}
			else {
				currentMouseX += (-1e3 - currentMouseX) * .08;
				currentMouseY += (-1e3 - currentMouseY) * .08;
			}
			if (isExiting) waveAmplitudeMultiplier += (0 - waveAmplitudeMultiplier) * .1;
			const drawFluidWave = (phase, baseHeight, amplitude, frequency, gradientTopColor, gradientBottomColor) => {
				ctx.beginPath();
				ctx.moveTo(0, height);
			...
			drawFluidWave(phase1, height * .88, 28, .0016, "rgba(229, 72, 77, 0.08)", "rgba(229, 72, 77, 0.002)");
			drawFluidWave(phase2, height * .91, 20, .0034, "rgba(229, 72, 77, 0.16)", "rgba(229, 72, 77, 0.005)");
			drawFluidWave(phase3, height * .94, 14, .0062, "rgba(229, 72, 77, 0.28)", "rgba(229, 72, 77, 0.01)");
			phase1 += isExiting ? .06 : .004;
			phase2 -= isExiting ? .04 : .005;
			phase3 += isExiting ? .08 : .009;
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
							...
							].map((dot, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
								cx: dot.cx,
								cy: dot.cy,
								r: "7",
								fill: dot.f,
          ...
          ` }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-1 h-[2px] w-9 sm:w-9 rounded-full bg-[var(--accent)]" })]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 rounded-full border border-[var(--accent)] opacity-0 scale-95 transition-all duration-500 group-hover:opacity-60 group-hover:scale-100 pointer-events-none" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Enter" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-4 text-[var(--text-tertiary)] transition-transform duration-300 group-hover:translate-x-1.5 group-hover:text-[var(--accent)]" })
							]
						})
					})
				]
...
function Index() {
	...
	const popularByCategory = (0, import_react.useMemo)(() => {
		...
		return [
			...
			const sorted = sortChannels(cat.data.indexes.by_category[id] ?? [], cat.data.channels, userCountry, health);
			return {
				id,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		showLanding && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ImmersiveLanding, { onClose: handleCloseLanding }),
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: "Feel Everything"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-1 h-[2px] w-9 rounded-full bg-[var(--accent)]" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									...
									children: ["Browse channels ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-3.5" })]
								})
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-6 flex flex-wrap gap-x-8 gap-y-2 font-mono text-[11.5px] text-[var(--text-tertiary)] hero-item",
								style: { animationDelay: "220ms" },
								children: [cat.data && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
											className: "text-[var(--text-primary)]",
											children: cat.data.meta.countries.filter((c) => (cat.data.indexes.by_country[c.code]?.length ?? 0) > 0).length
										}),
										" ",
										"countries"
									] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
											className: "text-[var(--text-primary)]",
											children: cat.data.meta.languages.filter((l) => (cat.data.indexes.by_language[l.code]?.length ?? 0) > 0).length
										}),
										" ",
										"languages"
									] })
								] }), !cat.data && cat.isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "shimmer h-3 w-32 rounded" })]
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: "Feel Everything"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-1 h-[2px] w-7 rounded-full bg-[var(--accent)]" })]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: ["Browse channels ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-3" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							] }), !cat.data && cat.isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "shimmer h-2.5 w-28 rounded" })]
						})
					]
				})
			]
		...
		cat.isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: Array.from({ length: 3 }).map((_, s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "shimmer mb-4 h-2.5 w-20 rounded-full" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex gap-3 overflow-hidden",
				children: Array.from({ length: 7 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		cat.data && featured && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BackgroundPingTrigger, {
			channelIds: visibleIdsForBackgroundCheck,
			channels: cat.data.channels,
			limit: 24
		}), popularByCategory.map((shelf) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shelf, {
			title: shelf.name,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HorizScroll, { children: shelf.ids.map((id) => {

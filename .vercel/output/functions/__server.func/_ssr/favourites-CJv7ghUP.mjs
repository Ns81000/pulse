...
//#region node_modules/.nitro/vite/services/ssr/assets/favourites-CJv7ghUP.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function AlternativesShelf({
  catalog,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
        className:
          "mb-3 font-display text-sm font-medium uppercase tracking-wider text-[var(--text-secondary)]",
        children: title,
      }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HorizScrollShelf, {
        children: ids.map((id) => {
          const c = catalog.channels[id];
          if (!c) return null;
...
function FavPage() {
  ...
  (0, import_react.useEffect)(() => {
    const load = async () => {
      ...
      setRecent(
        hist
          .filter((h) => (seen.has(h.channelId) ? false : (seen.add(h.channelId), true)))
          .slice(0, 12)
          .map((h) => h.channelId),
      );
      setLoaded(true);
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
            className:
              "mb-4 flex items-center gap-2 font-display text-[13px] font-medium uppercase tracking-[0.14em] text-[var(--text-secondary)]",
            children: [
          ...
          !loaded
            ...
            : favIds.length === 0
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "grid place-items-center rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-1)] px-6 py-12 text-center",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
      ...
      recent.length > 0 &&
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
              className:
                "mb-4 font-display text-[13px] font-medium uppercase tracking-[0.14em] text-[var(--text-secondary)]",
      ...
      recent.length > 0 &&
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className: "shimmer mb-4 h-3 w-36 rounded-full",
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {

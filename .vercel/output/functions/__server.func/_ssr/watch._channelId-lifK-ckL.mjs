...
import {
  ...
  l as Settings,
  m as Pause,
  p as PictureInPicture2,
  r as VolumeX,
  y as Heart,
} from "../_libs/lucide-react.mjs";
import { t as Route } from "./watch._channelId-DSrE9c_k.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/watch._channelId-lifK-ckL.js
...
function Player({ channel, onFatalError, compact }) {
  ...
  const [activeStreamIdx, setActiveStreamIdx] = (0, import_react.useState)(
  ...
  const onVolume = (0, import_react.useCallback)(
    (val) => {
      const v = player.videoEl;
      if (!v) return;
      v.volume = val;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      ...
      loadState === "error" &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "absolute inset-0 z-[25] grid place-items-center bg-black/80 text-center text-white",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                onClick: reload,
                className:
                  "mt-3 inline-flex items-center gap-1.5 rounded-full bg-white px-4 py-1.5 text-[12px] font-medium text-black hover:bg-white/90",
                children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        showSettings &&
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "absolute bottom-[44px] right-0 min-w-[140px] overflow-hidden rounded-lg border border-white/10 bg-black/90 p-1 backdrop-blur",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                                onClick: () => {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    ...
                    className: "ctrl-btn",
                    children: fullscreen
                      ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Minimize2, {
                          className: "size-4",
                        })
...
function WatchPage() {
  ...
  if (cat.isLoading)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      className: "shimmer mx-auto aspect-video max-w-5xl rounded-xl",
    });
  if (!channel)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
        onClick: onBack,
        className:
          "mb-4 inline-flex items-center gap-1.5 text-[12px] text-[var(--text-tertiary)] hover:text-[var(--text-primary)] transition-colors active:scale-95",
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              showPlayer &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-black shadow-lg",
              ...
              (status === "checking" || status === "recovering") &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "shimmer relative aspect-video w-full rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)]",
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className: "absolute inset-0 flex flex-col items-center justify-center gap-3",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "size-8 animate-spin rounded-full border-2 border-[var(--border-default)] border-t-[var(--accent)]",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                        className:
                          "text-[12px] text-[var(--text-tertiary)] font-medium animate-pulse",
                        children:
                          status === "checking"
              ...
              showRecovery &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] p-6",
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                            ...
                            children:
                              "Public IPTV links come and go. Try an alternative below — they're picked from channels in the same category.",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                            onClick: () => runCheck(true),
                            className:
                              "btn-ghost mt-3 text-[12px] active:scale-95 transition-transform",
                            children: "Try again",
                          }),
                        ],
                      }),
                      ...
                      children: [
                        ...
                        catNames.length > 0 &&
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            ...
                            children: catNames.map((n) =>
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "span",
                                {
                                  className:
                                    "rounded-full bg-[var(--surface-2)] px-2.5 py-1 text-[11px] text-[var(--text-tertiary)] font-medium",
                                  children: n,
                                },
                                n,
                              ),
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                          onClick: toggleFav,
                          className:
                            "btn-ghost inline-flex items-center gap-1.5 active:scale-95 transition-transform",
                          children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                ...
                children:
                  cat.data &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MobileAlternativesGrid, {
                    catalog: cat.data,
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                  className:
                    "mb-3 font-mono text-[10.5px] font-bold uppercase tracking-[0.14em] text-[var(--text-tertiary)] shrink-0",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children:
                    cat.data &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlternativesVerticalList, {
                      catalog: cat.data,
                      failedChannelId: channel.id,
                      limit: 8,
                    }),
...
function MobileAlternativesGrid({ catalog, failedChannelId, showRecovery }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
        className:
          "mb-3 font-mono text-[10.5px] font-bold uppercase tracking-[0.14em] text-[var(--text-tertiary)]",
        ...
        children: ids.map((id) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              ...
              className:
                "flex flex-col overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] text-left transition-all active:scale-[0.97] active:bg-[var(--surface-2)]",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "relative aspect-video w-full bg-[var(--surface-2)] flex items-center justify-center",
                  children: c.logo_url
                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                        src: c.logo_url,
                        alt: c.name,
...
function AlternativesVerticalList({ catalog, failedChannelId, limit = 6 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ...
    children: (0, import_react.useMemo)(() => {
      ...
      return result;
    }, [catalog, failedChannelId, limit]).map((id) => {
      const c = catalog.channels[id];
      if (!c) return null;
      const code = c.country ? toFlagCode(c.country) : "";
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "button",
        {
          ...
          className:
            "flex items-start gap-3 w-full p-1.5 text-left rounded-lg hover:bg-[var(--surface-2)] transition-all duration-150 active:scale-[0.985]",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "relative aspect-video w-28 h-[63px] shrink-0 rounded-md bg-[var(--surface-base)] border border-[var(--border-subtle)] flex items-center justify-center overflow-hidden",
              children: c.logo_url
                ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                    src: c.logo_url,
                    alt: "",
                ...
                : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tv, {
                    className: "size-5 text-[var(--text-disabled)]",
                  }),
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                c.categories.length > 0
                  ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      className:
                        "truncate text-[11.5px] text-[var(--text-secondary)] mt-1.5 font-medium",
                      children: c.categories[0],
                    })
                  : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      className:
                        "text-[10px] text-[var(--text-disabled)] mt-1.5 font-mono text-[9px] uppercase tracking-wide",

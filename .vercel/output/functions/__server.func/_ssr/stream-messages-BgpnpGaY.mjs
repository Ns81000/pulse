...
//#region node_modules/.nitro/vite/services/ssr/assets/stream-messages-BgpnpGaY.js
      ...
      upgrade(db, oldVersion) {
        if (oldVersion < 1) {
          ...
          if (!db.objectStoreNames.contains("history"))
            db.createObjectStore("history", { keyPath: "watched_at" }).createIndex(
              "by_channel",
              "channelId",
            );
  ...
  (async () => {
    ...
    .finally(() => {
      ...
      if (typeof window !== "undefined" && "requestIdleCallback" in window)
        window.requestIdleCallback(() => processQueue(), { timeout: 1e3 });
...
//#endregion
export {
  useStreamHealth as _,
  isFavourite as a,
  queueBackgroundCheck as c,
  removeFavourite as d,
  sortChannels as f,
  usePlayer as g,
  useChannelHealth as h,
  getWorkingStreamIndex as i,
  recordHealth as l,
  useCatalog as m,
  addFavourite as n,
  listFavourites as o,

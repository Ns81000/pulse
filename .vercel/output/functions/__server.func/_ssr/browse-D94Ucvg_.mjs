...
//#region node_modules/.nitro/vite/services/ssr/assets/browse-D94Ucvg_.js
var search = objectType({
  category: stringType().optional(),
  language: stringType().optional(),
  country: stringType().optional(),
  q: stringType().optional(),
  sort: enumType(["name", "country", "popular"]).optional(),
});
var $$splitComponentImporter = () => import("./browse-Bai_xYX1.mjs");

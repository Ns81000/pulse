...
//#region node_modules/.nitro/vite/services/ssr/assets/ChannelGrid-Dub8fZov.js
...
function ChannelGrid({ catalog, channelIds }) {
  ...
  if (channelIds.length === 0)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      className:
        "grid place-items-center rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-1)] px-6 py-16 text-center",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
        ...
        children: ["Showing ", visible.length, " of ", channelIds.length],
      }),
    ],
  });
}

...
import { d as removeFavourite, g as usePlayer, h as useChannelHealth, l as recordHealth, n as addFavourite, o as listFavourites, p as streamErrorMsg, r as checkStream } from "./stream-messages-Bqm6fwz2.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/use-favourites-CxjJPCnd.js
...
function ChannelCardBase({ channel, flag, countryName, isFavourite, onFavouriteChange, categoryName }) {
	...
	const onFav = (0, import_react.useCallback)(async (e) => {
		e.stopPropagation();
		if (isFavourite) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					channel.logo_url && !imgError ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: `size-3.5 ${isFavourite ? "fill-[var(--accent)] text-[var(--accent)]" : "text-white"}` })
					}),
					status !== "idle" && status !== "recovering" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			cats.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {

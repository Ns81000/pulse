...
import { t as Route } from "./browse-D94Ucvg_.mjs";
import {
  C as ChevronRight,
  D as ArrowUpDown,
  E as Check,
  T as ChevronDown,
  c as SlidersHorizontal,
  n as X,
  u as Search,
  w as ChevronLeft,
} from "../_libs/lucide-react.mjs";
import { t as ChannelGrid } from "./ChannelGrid-Dub8fZov.mjs";
import { t as BackgroundPingTrigger } from "./BackgroundPingTrigger-nSKP9mKW.mjs";
import { t as Drawer } from "../_libs/vaul.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/browse-Bai_xYX1.js
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
        ...
        onClick: () => setOpen((o) => !o),
        className:
          "flex w-full items-center justify-between text-[11px] font-medium uppercase tracking-wider text-[var(--text-secondary)]",
        children: [
...
function FilterPanel({ catalog, selected, onChange }) {
  const langs = (0, import_react.useMemo)(
    () =>
        ...
        children: [
          ...
          hasAny &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
              ...
              className:
                "inline-flex items-center gap-1 text-[11px] text-[var(--text-tertiary)] hover:text-[var(--text-primary)]",
              children: [
...
var Drawer$1 = ({ shouldScaleBackground = true, ...props }) =>
...
var DrawerOverlay = import_react.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drawer.Overlay, {
    ref,
...
var DrawerContent = import_react.forwardRef(({ className, children, ...props }, ref) =>
  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DrawerPortal, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DrawerOverlay, {}),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Drawer.Content, {
        ref,
        className: cn(
...
var DrawerHeader = ({ className, ...props }) =>
  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    className: cn("grid gap-1.5 p-4 text-center sm:text-left", className),
    ...props,
  });
DrawerHeader.displayName = "DrawerHeader";
var DrawerFooter = ({ className, ...props }) =>
  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    className: cn("mt-auto flex flex-col gap-2 p-4", className),
    ...props,
  });
DrawerFooter.displayName = "DrawerFooter";
var DrawerTitle = import_react.forwardRef(({ className, ...props }, ref) =>
...
var DrawerDescription = import_react.forwardRef(({ className, ...props }, ref) =>
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
              "text-[10px] font-semibold uppercase tracking-[0.1em] text-[var(--text-tertiary)]",
            children: label,
          }),
          active &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
              ...
              className:
                "flex items-center gap-1 rounded-full bg-[var(--accent-subtle)] px-2 py-0.5 text-[10px] font-medium text-[var(--accent)] transition-opacity active:opacity-70",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "size-2.5" }),
                "Clear",
              ],
            }),
        ],
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
            className:
              "pointer-events-none absolute left-3 top-1/2 size-3.5 -translate-y-1/2 text-[var(--text-tertiary)]",
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
            className:
              "h-9 w-full rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-2)] pl-8 pr-3 text-[13px] text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] outline-none focus:border-[var(--accent)] transition-colors",
            placeholder: `Search ${label.toLowerCase()}…`,
            value: q,
            onChange: (e) => setQ(e.target.value),
          }),
          q &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
              ...
              onClick: () => setQ(""),
              className:
                "absolute right-2.5 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)] active:text-[var(--text-primary)]",
        ...
        children: [
          ...
          filtered.length === 0 &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
              ...
              children: ["No ", label.toLowerCase(), " matches"],
            }),
        ],
      }),
    ],
...
function ActiveChip({ label, onRemove }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
    className:
      "inline-flex items-center gap-1.5 rounded-full border border-[var(--accent)]/30 bg-[var(--accent-subtle)] px-3 py-1 text-[11px] font-medium text-[var(--accent)]",
    children: [
      label,
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
        type: "button",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
    ...
    children: [
      ...
      activeCount > 0 &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
          className:
            "flex h-4 min-w-4 items-center justify-center rounded-full bg-[var(--accent)] px-1 text-[10px] font-bold text-white",
...
function MobileFilterDrawer({ open, onOpenChange, catalog, selected, resultCount, onChange }) {
  ...
  const activeCountryName = (0, import_react.useMemo)(
    () => countries.find((c) => c.id === selected.country)?.name,
    [countries, selected.country],
  );
  const activeLanguageName = (0, import_react.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drawer$1, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DrawerContent, {
      className:
        "flex max-h-[92vh] flex-col bg-[var(--surface-base)] border-[var(--border-subtle)] px-0 pb-0",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                activeCount > 0 &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    className:
                      "flex h-5 min-w-5 items-center justify-center rounded-full bg-[var(--accent)] px-1.5 text-[10px] font-bold text-white",
                    children: activeCount,
                  }),
              ],
            }),
              ...
              children: [
                hasAny &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    ...
                    onClick: clearAll,
                    className:
                      "text-[12px] font-medium text-[var(--text-tertiary)] underline-offset-2 hover:text-[var(--text-primary)] active:opacity-60 transition-colors",
                    children: "Clear all",
                  }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DrawerClose, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    ...
                    className:
                      "flex size-7 items-center justify-center rounded-full bg-[var(--surface-3)] text-[var(--text-secondary)] transition-colors active:bg-[var(--surface-4)]",
        ...
        hasAny &&
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              activeCountryName &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ActiveChip, {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "shrink-0 border-t border-[var(--border-subtle)] bg-[var(--surface-base)] px-5 pb-[env(safe-area-inset-bottom,16px)] pt-4",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DrawerClose, {
            asChild: true,
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
              type: "button",
              className:
                "flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--accent)] py-3.5 text-[14px] font-semibold text-white shadow-lg transition-all active:scale-[0.98] active:opacity-90",
              children: [
                "Show ",
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
          ...
          onClick: () => scroll("left"),
          className:
            "pointer-events-auto hidden size-7 items-center justify-center rounded-full bg-[var(--surface-3)]/80 text-[var(--text-secondary)] backdrop-blur-sm transition-colors hover:bg-[var(--surface-4)] hover:text-[var(--text-primary)] sm:flex",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      ...
      open &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "absolute right-0 top-[calc(100%+6px)] z-50 min-w-[130px] overflow-hidden rounded-lg border border-[var(--border-default)] bg-[var(--surface-2)] py-1 shadow-xl dropdown-enter",
...
function BrowsePage() {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (
      !!!(selected.category || selected.language || selected.country || selected.q || selected.sort)
    ) {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
                    className:
                      "pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-[var(--text-tertiary)]",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                    value: selected.q ?? "",
                  ...
                  selected.q &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                      ...
                      "aria-label": "Clear",
                      className:
                        "absolute right-2 top-1/2 grid size-6 -translate-y-1/2 place-items-center rounded text-[var(--text-tertiary)] hover:text-[var(--text-primary)]",
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
                        className: "size-3.5",
                      }),
                    }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MobileFilterTrigger, {
                activeCount: [selected.category, selected.language, selected.country].filter(
                  Boolean,
                ).length,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
            ...
            children: [
              cat.isLoading &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "space-y-4 rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-1)] p-4",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      className: "shimmer h-3.5 w-16 rounded-full",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className: "space-y-2 border-t border-[var(--border-subtle)] pt-4",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className: "shimmer h-2.5 w-20 rounded-full",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className: "shimmer h-8 w-full rounded-lg",
                        }),
                        Array.from({ length: 6 }).map((_, i) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                                  className: "shimmer h-4 w-5 rounded-[2px]",
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
